...
import { Tab, Tabs, TabList, TabPanel } from "react-tabs"; // this are taken from material ui the react library the ready made components...
    ...
    <>
      <div className="container mx-auto">
        <div className="tab container mx-auto ">
          {
            // here tabs is the container which has tablist along with the tab panels associated with it...
          }
          ...
          <Tabs defaultIndex={0} className=" ">
            ...
            {
              // tab panels associated with tabs starts from here...
              // we are iterating over the product state i.e the data fetched from firebase and we are returning the tbody which contains
              // tr along with the td's  in it....
            }
