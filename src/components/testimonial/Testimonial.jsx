          ...
          <div className="flex flex-wrap -m-4">
            <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
              <div className="h-full text-center">
                ...
                >
                  I've been shopping online for years, and I have to say, this
                  ecommerce platform stands out from the rest. The variety of
                  products available is amazing, and the user interface is so
                  intuitive. I never have trouble finding what I need, and the
